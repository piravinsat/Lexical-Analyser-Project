/*******************************************************************************
*
* Parser generated by RDP on Oct 24 2013 20:32:04 from regex4.bnf
*
*******************************************************************************/
#include <time.h>
#include "regex4.h"
...
char
  ...
  *rdp_outputfilename = "regex4.out";         /* output file name */
...
static void rdp_set_initialise(void)
{
  ...
  set_assign_list(&alt_stop, SCAN_P_ID, SCAN_P_EOF, RDP_T_35 /* # */, RDP_T_40 /* ( */, RDP_T_41 /* ) */,SET_END);
  set_assign_list(&con_first, SCAN_P_ID, RDP_T_35 /* # */, RDP_T_40 /* ( */, SET_END);
  set_assign_list(&con_stop, SCAN_P_EOF, RDP_T_41 /* ) */,SET_END);
...
{
  {
    ...
    { /* Start of rdp_con_1 */
      while (1)
      {
        ...
        if (!scan_test_set(NULL, &rdp_con_1_first, NULL)) break;
      }
    } /* end of rdp_con_1 */
