/*******************************************************************************
*
* Parser generated by RDP on Oct 15 2013 08:59:38 from arith2.bnf
*
*******************************************************************************/
#include <time.h>
#include "arith2.h"
...
char
  ...
  *rdp_outputfilename = "arith2.out";         /* output file name */
...
integer E(void)
{
  ...
  integer val2;
  {
    scan_test(NULL, SCAN_P_INTEGER, &E_stop);
    val1 = SCAN_CAST->data.i;
    scan_();
    ...
    {
      /* default action processing for rdp_E_1*/
result=val1;
    }
