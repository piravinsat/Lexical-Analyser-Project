/*******************************************************************************
*
* Parser generated by RDP on Oct 14 2013 17:49:53 from minitree.bnf
*
*******************************************************************************/
#include <time.h>
#include "ml_aux.h"
...
char
  ...
  *rdp_outputfilename = "minitree.mvm";         /* output file name */
...
#define check_declared  if (symbol_lookup_key(mini, &name, NULL) == NULL)\
                      {\
...
e2(rdp_tree);
    ...
    {
      /* default action processing for rdp_e1_2*/
      if (rdp_tree_update) {rdp_tree_node_data *temp = rdp_add_child(NULL, rdp_tree); temp->id = NULL; temp->token = SCAN_P_ID;}
    }
